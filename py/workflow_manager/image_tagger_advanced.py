...
class ImageTagger:
    ...
    TEMPLATE_DIRECTORY = os.path.join(BASE_DIRECTORY, "TEMPLATE_IMAGES")
    PROTECTED_DIRECTORY_PATHS = [BASE_DIRECTORY, APPROVED_DIRECTORY, CACHED_DIRECTORY, TEMPLATE_DIRECTORY]
